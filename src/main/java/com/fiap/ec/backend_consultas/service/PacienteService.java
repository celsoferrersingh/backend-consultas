...
public class PacienteService {
    ...
    public Paciente salvar(Paciente paciente) {
        ...
        if (paciente.getAtivo() == null) paciente.setAtivo(true);
    ...
    private void normalizar(Paciente paciente) {
        if (paciente.getNome() != null) paciente.setNome(paciente.getNome().trim());
        if (paciente.getCpf() != null) paciente.setCpf(paciente.getCpf().replaceAll("\\D", ""));
        if (paciente.getEmail() != null) paciente.setEmail(paciente.getEmail().trim());
        if (paciente.getTelefone() != null && paciente.getTelefone().isBlank()) paciente.setTelefone(null);
    }
