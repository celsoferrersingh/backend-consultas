 ...
 * =============================================================================
 *
 * Responsabilidade: Exibir os dados de UMA consulta médica de forma organizada
 *
 * Props:
 * - consulta: objeto com todos os dados (OBRIGATÓRIA)
 * - onConfirmar: callback ao confirmar (OPCIONAL)
 * - onCancelar: callback ao cancelar (OPCIONAL)
 *
 * =============================================================================
 */
...
// Type LOCAL — usado apenas neste componente
...
export default function ConsultaCard({
  ...
  // Formata número para moeda brasileira (R$ 350,00)
  ...
  // Formata data no padrão brasileiro (10/03/2026)
  ...
  return (
    <View style={styles.card}>
      ...
      {/* Botões de ação — só aparecem se a consulta estiver agendada */}
